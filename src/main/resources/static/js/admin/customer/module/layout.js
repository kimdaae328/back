...
<!--                    모달 내용 들어와야함-->
    ...
    const customerCount = (criteria) => {
        const customerCountText = document.querySelector("#content-area .count-amount");
    ...
    return {contentLayout, showList, showNonSubscribedList, showSubscribedList, renderPagination, connectToPagination, customerCount, showDetail};
})();
                                                    ...
                                                    <div id="pop-menu-bt2" class="bt-pop-menu-context exists" style="top: 0px; bottom: unset; left: -64.75px; right: unset; transform: scale(0.9, 0.9) translate3d(0px, 0px, 0px);">
                                                        <ul class="list-wrapper list-unstyled">
                                                            ...
                                                            <li id="checkboxactive1"class="list-item">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="boot-check d-flex align-items-center undefined">
                                                                            <div class="boot-check-box " tabindex="0" style="width: 20px; height: 20px;">
                                                                                <i class="mdi mdi-check" style="display: inline-block;"></i>
                                                                            </div>
                                                                            <div class="boot-check-content flex-grow-1">
                                                                            답변완료
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<!--                모달 들어옴-->
    ...
    return {contentLayout, showList, renderPagination, connectToPagination, customerCount, showDetail};
})();